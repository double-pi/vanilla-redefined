...
import com.doublepi.vanilla_redefined.registries.ModBlocks;
import com.doublepi.vanilla_redefined.registries.ModMenuTypes;
...
public class ForgeMenu extends AbstractContainerMenu {
    ...
    public ForgeMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
