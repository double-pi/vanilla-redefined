...
import com.doublepi.vanilla_redefined.blocks.ForgeBlock;
...
public class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(VanillaRedefinedMod.MODID);
