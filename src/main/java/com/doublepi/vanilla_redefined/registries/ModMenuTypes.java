...
import com.doublepi.vanilla_redefined.blocks.ForgeMenu;
import com.doublepi.vanilla_redefined.blocks.ForgeScreen;
...
public class ModMenuTypes {
    ...
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, VanillaRedefinedMod.MODID);
